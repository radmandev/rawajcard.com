...
export default function TemplateNoqtatain2({ card, isRTL, onLinkClick }) {
  ...
  const backgroundColor = card.design?.background_color || '#F5F5F5';
    ...
    >
      ...
      <div className="relative w-full overflow-hidden" style={{ backgroundColor: primaryColor }}>
        ...
        <div className="relative h-64">
          ...
          <div className="absolute inset-0 bg-gradient-to-b from-transparent to-current" style={{ color: primaryColor }} />
        </div>
        ...
        <div className="px-6 py-6 text-white text-center">
          ...
          {card.company_logo && (
            <img src={card.company_logo} alt="" className="h-12 mx-auto mt-4 brightness-200" />
          )}
        ...
        {card.website && (
          ...
          >
            <div className="flex items-center gap-3">
              ...
              <span className="font-medium">{isRTL ? 'زيارة الموقع' : 'Visit Website'}</span>
            </div>
            <svg className="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
