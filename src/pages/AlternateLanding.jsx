      ...
      >
        <div className="relative overflow-hidden bg-slate-50 aspect-square">
          <motion.img
            ...
            onError={(e) => { if (e.target instanceof HTMLImageElement) e.target.src = 'https://placehold.co/400x400/f1f5f9/94a3b8?text=Product'; }}
          />
              ...
              <div className="relative w-full max-w-md">
                ...
                <div className="relative bg-white/5 backdrop-blur-sm rounded-3xl border border-white/10 p-6 shadow-2xl overflow-hidden">
                  <motion.img
                    ...
                    onError={(e) => { if (e.target instanceof HTMLImageElement) e.target.src = 'https://placehold.co/600x600/1e293b/94a3b8?text=Rawajcard'; }}
                  />
